...
spell_maps = {
    ...
    ['Pyrohelix II']='Helix2',['Cryohelix II']='Helix2',['Anemohelix II']='Helix2',['Geohelix II']='Helix2',['Ionohelix II']='Helix2',['Hydrohelix II']='Helix2',['Luminohelix II']='LightHelix2',['Noctohelix II']='DarkHelix2',
...
nukes.t2 = {['Earth']="Stone II",   ['Water']="Water II",   ['Wind']="Aero II",  ['Fire']="Fire II", ['Ice']="Blizzard II",  ['Lightning']="Thunder II", ['Light']="Fire II", ['Dark']="Stone II"}
nukes.t3 = {['Earth']="Stone III",  ['Water']="Water III",  ['Wind']="Aero III", ['Fire']="Fire III",['Ice']="Blizzard III", ['Lightning']="Thunder III", ['Light']="Fire III", ['Dark']="Stone III"}
nukes.t4 = {['Earth']="Stone IV",   ['Water']="Water IV",   ['Wind']="Aero IV",  ['Fire']="Fire IV", ['Ice']="Blizzard IV",  ['Lightning']="Thunder IV", ['Light']="Fire IV", ['Dark']="Stone IV"}
nukes.t5 = {['Earth']="Stone V",    ['Water']="Water V",    ['Wind']="Aero V",   ['Fire']="Fire V",  ['Ice']="Blizzard V",   ['Lightning']="Thunder V", ['Light']="Fire V", ['Dark']="Stone V"}
...
wantedSc = tier2sc[elements.current]
...
function midcast(spell)
	...
	elseif player.status ~= 'Engaged' and (spell.skill == 'Elemental Magic' or spell.name:match('Drain') or spell.name:match('Aspir')) and spellMap ~= 'Helix' and spellMap ~= 'Helix2' and spellMap ~= 'DarkHelix2' and spellMap ~= 'LightHelix2' then
		--not melee range so only overwrite with obi with any weather or day
		--check weather
		...
		elseif spell.element == "Water" and spell.element == world.weather_element and (get_weather_intensity() == 2  or world.day_element ~= "Lightning") then 
			equip(sets.midcast.Obi)
		elseif spell.element == "Dark" and spell.element == world.weather_element and (get_weather_intensity() == 2  or world.day_element ~= "Light") then 
			equip(sets.midcast.Obi)
		elseif spell.element == "Light" and spell.element == world.weather_element and (get_weather_intensity() == 2  or world.day_element ~= "Dark") then 
			equip(sets.midcast.Obi)
		--check day
		...
		elseif spell.element == "Water" and spell.element == world.day_element and  world.weather_element ~= "Lightning" then 
			equip(sets.midcast.Obi)
		elseif spell.element == "Dark" and spell.element == world.day_element and world.weather_element ~= "Light" then 
			equip(sets.midcast.Obi)
		elseif spell.element == "Light" and spell.element == world.day_element and world.weather_element ~= "Dark" then 
			equip(sets.midcast.Obi)
        ...
        elseif commandArgs[1]:lower() == 'sc' then
            ...
            if arg == 'castsc' then
                ...
                elseif wantedSc == 'Distortion' then
                    send_command('input /p Opening SC: Distortion  MB: Water / Ice; wait .1; input /ja "Immanence" <me>; wait 1.5; input /ma "Luminohelix" <t>; wait 5.0; input /ja "Immanence" <me>; wait 1.5; input /p Closing SC: Distortion  MB: Water / Ice; input /ma "Geohelix" <t>')                   
...
function handle_strategems(cmdParams)
    ...
    else --assume light arts if too many buffs to tell
        if strategem == 'cost' then
            send_command('input /ja Penury <me>')
        elseif strategem == 'speed' then
            send_command('input /ja Celerity <me>')
...
function selectSCElement()
    ...
    if last_skillchain.english == "Light" or last_skillchain.english == "Radiance"  then
        ...
        if elements.current == "Fire" or elements.current == "Lightning" or elements.current == "Wind" or elements.current == "Light" then
            return
    ...
    elseif last_skillchain.english == "Darkness" or last_skillchain.english == "Umbra"  then
        -- First we always prefer the selected element if that element can burst, if not we move on.
        if elements.current == "Earth" or elements.current == "Water" or elements.current == "Ice" or elements.current == "Dark" then
            return
    ...
    -- In case of Fusion and Grav light and dark use fire and earth for normal nukes
    ...
    elseif last_skillchain.english == "Gravitation" then
		if elements.current == "Earth" or elements.current == "Dark" then
			return
			--otherwise favor darkness unless the weather is either good for earth or bad for darkness
		elseif (world.day_element == "Earth" and world.weather_element ~="Wind") or (world.weather_element == "Earth" and world.day_element ~="Wind") or (world.weather_element == "Earth" and get_weather_intensity() == 2) or 
		(world.day_element == "Light" and  world.weather_element ~="Dark") or (world.weather_element == "Light" and  world.day_element ~="Dark") or (world.weather_element == "Light" and get_weather_intensity() == 2)then
            selectedElement = "Earth"
            elements:set(selectedElement)
		else
    ...
    elseif last_skillchain.english == "Fusion" then
        if elements.current == "Light" or elements.current == "Fire" then
			return
			--otherwise favor Light unless the weather is either good for fire or bad for light
		elseif (world.day_element == "Fire" and world.weather_element ~="Water") or (world.weather_element == "Fire" and world.day_element ~="Water") or (world.weather_element == "Fire" and get_weather_intensity() == 2) or 
		(world.day_element == "Dark" and  world.weather_element ~="Light") or (world.weather_element == "Dark" and  world.day_element ~="Light") or (world.weather_element == "Dark" and get_weather_intensity() == 2)then
            selectedElement = "Fire"
            elements:set(selectedElement)
		else
